...
{
    double origin_point_vector[2] = {point[0] - view_origin[0], point[1] - view_origin[1]};

    double rec_view_vector_length = 1.0/sqrt(pow(view_vector[0], 2.0) + pow(view_vector[1], 2.0));

    double norm_view_vector[2] = {view_vector[0]*rec_view_vector_length, view_vector[1]*rec_view_vector_length};

    double rec_origin_point_vector_length = 1.0/sqrt(pow(origin_point_vector[0], 2.0) + pow(origin_point_vector[1], 2.0));
